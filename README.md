...
For each obsolete message, we update both the "target" neighbors dictionar, decreasing the number of transactions with the "actor", and, viceversa,
...
The script insight_testsuite/generate_shuffled_data_gen_test.py generates <n> random shuffled tests from the data_gen/venmo-trans.txt list of transactions.
<pre>
